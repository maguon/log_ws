...
const md5Key = "mp".toString('ascii');
const aceKey = "mission";
...
const utf8Decode = (encodeText) =>{
    ...
    while ( i < encodeText.length ) {
        ...
        if (c < 128) {
            ...
            c2 = encodeText.charCodeAt(i+1);
            let c3 = encodeText.charCodeAt(i+2);
...
module.exports = {
     encryptByMd5,encryptByMd5Key , encryptByAES, decryptByAES, createActiveCode,resolveActiveCode,
    base64Decode, base64Encode,createLoginEmailCode,resolveLoginEmailCode, encryptByMd5NoKey,createGiftCode ,resolveGiftCode,
    getGiftOrderCode  , getSmsRandomKey
};